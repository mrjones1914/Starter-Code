...
.NOTES
    ...
    1.3.1 -   Added check for version 2004 and 20H2 ; renamed to "Install-RSATvCurrent.ps1" - MRJ 30APR2021
...
if (($WindowsBuild -eq $1809Build) -OR ($WindowsBuild -eq $1903Build) -OR ($WindowsBuild -eq $1909Build) -OR ($WindowsBuild -eq $19041Build) -OR ($WindowsBuild -eq $19042Build)) {
