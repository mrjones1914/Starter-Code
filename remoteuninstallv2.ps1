<#
 Remote Uninstaller v2.0 
 Credits:                                                                             
 Felipe Binotto - Thanks Felipe                                                       
#>
...
##############################################################
    ...
    $Infolabel.Text = "!! INFORMATION : Make sure you List Programs first. Don't be too vague when specifying the" +
